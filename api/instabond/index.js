// Vercel Serverless Proxy to Hetzner InstaBond API
// This bypasses CORS and provides a fallback endpoint
...
export default async function handler(req, res) {
  ...
  // This handles /api/instabond (base route) -> forwards to Hetzner /api/instabond
  const targetUrl = `${HETZNER_API}/api/instabond`;
  ...
  try {
    ...
    return res.status(503).json({
      success: false,
      error: 'InstaBond service temporarily unavailable',
